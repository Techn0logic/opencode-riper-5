...
3. Before continuing the rebase, run the project's pre-commit quality checks. Look for .opencode/project-info.md or similar in the repo root to find the project's required checks. Common checks include:
   - Formatting: Check README.md or AGENTS.md for the project's format command
   - Linting: Check for lint command in project documentation
   - Type checking: Check for typecheck command in project documentation
