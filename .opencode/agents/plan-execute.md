...
- Write to repository root `.opencode/memory-bank/*/plans/` ONLY (use `git rev-parse --show-toplevel` to find root)
...
- Writing outside repository root `.opencode/memory-bank/*/plans/` directory
...
2. Then create plans at: `[ROOT]/.opencode/memory-bank/[branch]/plans/[branch]-[date]-[feature].md`

Example: If repository root is `/path/to/repo`, save to:
`/path/to/repo/.opencode/memory-bank/branch-name/plans/branch-name-2025-01-06-feature.md`
...
2. Load approved plan from `[ROOT]/.opencode/memory-bank/[branch]/plans/`
...
2. Save to: `[ROOT]/.opencode/memory-bank/[branch]/plans/[filename].md`
...
- ✅ Read: All files
- ✅ Write: ONLY to `[ROOT]/.opencode/memory-bank/*/plans/` (get ROOT via `git rev-parse --show-toplevel`)
...
2. No plan in: `[ROOT]/.opencode/memory-bank/[branch]/plans/`
